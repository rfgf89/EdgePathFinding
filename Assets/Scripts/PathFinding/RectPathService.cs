...
namespace DefaultNamespace
{
    ...
    {
        private readonly Dictionary<Rectangle, HashSet<Edge>> _rectNodes = new ();
        private readonly Dictionary<Vector2, HashSet<Edge>> _graph = new ();
        private readonly Dictionary<Vector2, KeyValuePair<int, bool>> _graphState = new ();
        ...
        private void AddToDicHash<T,U>(Dictionary<T, HashSet<U>> dictionary, T to, params U[] addVal)
        {
            ...
            {
                var values2 = new HashSet<U>(addVal.Length);
                foreach (var val in addVal)
                    values2.Add(val);
